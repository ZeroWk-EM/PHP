...
$list_name = array("Samuel", "Marco", "Simone", "Giuseppe", "Francesca", "Gloria", "Luca", "Anna", "Mario", "Giulia", "Carola", "Palermo",
                    "Vincenzo", "Maria", "Mirko", "Antonio", "Martina", "Gaetano", "Damiano", "Marika", "Sofia", "Alice", "Giorgia", "Albertone");

$list_surname = array("Rossi", "Ferrari", "Russo", "Bianchi", "Romano", "Costa", "Fontana" ,"Conti" ,"Esposito" ,"Ricci",
                    "De Luca", "Moretti", "Marino", "Greco", "Barbieri", "Lombardi", "Giordano", "Cassano" ,"Colombo",
                    "Mancini", "Longo", "Leone", "Martinelli", "Amato");

$list_profession = array("Professore", "Operaio", "Panettiere", "Agricoltore", "Calciatore", "Attore", "Sviluppatore", "Fruttivendolo",
...
$list_city = array("Caltagirone", "Catania", "Palermo", "Roma", "Messina", "Milano", "Torino", "Venezia", "Bologna", "Padova",
                    "Firenze", "Pescara", "Udine", "Bari", "Napoli", "Ferrara", "Pisa", "Empoli", "Verona", "Bergamo", "Cagliari",
                    "Perugia", "Modena", "Lecce");

$list_CF = array("NGNVRL63B67C709L", "PMMCMR96R09A946K", "CCRFSZ61C10H263B", "VCPLPB51T13L444V", "MPNRNY83R30A205K", "GLDMWT35T23H441L",
