...
<body>
        ...
        <div class="code">
            ...
            function generateList($num_pers, $list_CF)
            {
                ...
                for ($i = 0; $i < $num_pers; $i++) {
                    if (count($list_CF) != 0) {
                        $list_people[generateCF($list_CF)] = array(
                            "Name" => generateName(), "Surname" => generateSurname(), "Profession" => generateProfession(),
    ...
    <hr>
    <p style="text-align:right;">FINITO 17/06/2022 || 09:30</p>
</body>
